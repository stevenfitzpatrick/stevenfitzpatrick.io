...
const AboutMe = () =>
  <div class="content about_me">
    ...
    <p>
      ...
      passionate about to work with — but it’s also a hobby of mine. With new
      frameworks, libraries and languages coming out every day to learn it can
      be very time consuming to keep up with but I enjoy the challenge.
    </p>

    <p>
      Hacking away with Build Tools, Page Load Optimizations, Service Workers,
    ...
    <p>
      ...
      I will blog about my discoveries and many bugs I encounter in my{' '}
      ...
      which will be a list of interesting links I came across on the web. If you
