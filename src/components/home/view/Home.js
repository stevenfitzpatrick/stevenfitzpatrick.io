  ...
  return (
    <div>
      <section class={styles.home}>
        <h4>Hello & Welcome ! </h4>
        <h2>
          I’m Steven Fitzpatrick<span>.</span>
        </h2>
        <h5>
        ...
        {Contact && (
          <Contact displayShowMe={showAboutMe} hideAboutMe={toggleAboutMe} />
        )}
      </section>
      <section class={cx(styles.container, styles.aboutme)}>
        <div class="breakout-wrapper">
          ...
          <p>
            I&rsquo;m a <strong>passionate</strong> front-end developer based in
            Dublin with full-stack experience. When it comes to coding I like to
            keep it simple, maintainable and clean.
          </p>
          <p>
            I enjoy working with the latest and greatest tools of the front-end
            ecosystem&#8202;&mdash;&#8202;to build fast, responsive, accessible
