...
export default ({ hideAboutMe, displayShowMe }) => (
  <div
    class={cx(
      styles.aboutme,
      displayShowMe && styles['aboutme--visible']
    )}
  >
    <div
      tabIndex="-1"
    ...
    <div class={styles.aboutme__content}>
      ...
      <p>
				Hi there, if you have any questions about me, this site or any
				projects you need a hand with feel free to contact me on any
				of the links below !
      </p>
